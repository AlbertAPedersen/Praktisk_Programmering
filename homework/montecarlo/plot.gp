...
set title "Task 2 singular plot, halton sequence handles it much better"
plot "out.txt" index 2 using 1:3 with lines title "Halton error",\
     "out.txt" index 2 using 1:5 with lines title "lcg error",\



set title "Task 2 non-singular plot"
plot "out.txt" index 3 using 1:2 with lines title "Halton error",\
     "out.txt" index 3 using 1:3 with lines title "lcg error",\
     "out.txt" index 3 using 1:4 with lines title "c++ standard error"