...
namespace pp{
    ...
    struct matrix {
        ...
        matrix& operator*=(const matrix& B){ 
            //Takes one term of scalar product at a time on a column basis and adds the the next term for the next column, rather than entire scalar product at once
